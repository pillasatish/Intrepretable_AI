...
Original file is located at
    https://colab.research.google.com/drive/1TObjQi6D2w_wOPdhs_lPEJTu2fQLcVcD
"""
...
Original file is located at
    https://colab.research.google.com/drive/151I0kRpMDcLfM0ZfyRyxPC_tV33vFtNb
"""
...
def plot_concept_top50(args, val_loader, model, whitened_layers, print_other = False, activation_mode = 'pool_max'):
    ...
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/'
...
def get_representation_distance_to_center(args, val_loader, layer, arch='resnet_cw'):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + arch + str(args.depth) + '/distance_to_center/'
    if not os.path.exists(dst):
        os.makedirs(dst)
...
def intra_concept_dot_product_vs_inter_concept_dot_product(args, conceptdir, layer, plot_cpt = ['Controls','Patients'], activation_mode = 'mean', arch='resnet_cw', dataset = 'MD'):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/inner_product/'
    if not os.path.exists(dst):
        os.makedirs(dst)
...
'''
def plot_trajectory(args, val_loader, whitened_layers, plot_cpt = ['Controls','Patients']):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/trajectory_all/'
    if not os.path.exists(dst):
        os.makedirs(dst)
    concepts = args.concepts.split(',')
...
'''
def plot_auc_cw(args, conceptdir, whitened_layers, plot_cpt = ['Controls','Patients'], activation_mode = 'pool_max', dataset = 'MD'):
    # dst = '/content/plot/' + args.arch + str(args.depth) + '/auc/cw/'
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) +'/auc/'
    if not os.path.exists(dst):
        os.makedirs(dst)
    dst += 'cw/'
    if not os.path.exists(dst):
...
'''
def plot_auc_lm(args, model, concept_loaders, train_loader, conceptdir, whitened_layers, plot_cpt = ['Controls', 'Patients'], model_type = 'svm'):
    # dst = '/content/plot/' + 'resnet_cw' + str(args.depth) + '/auc/tcav/'
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) +'/auc/tcav/'
    if not os.path.exists(dst):
        os.makedirs(dst)
...
'''
def plot_auc_filter(args, model, conceptdir, whitened_layers, plot_cpt = ['Controls', 'Patients'], activation_mode = 'pool_max'):
    # dst = '/content/plot/' + 'resnet_cw' + str(args.depth) + '/auc/filter/'
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) +'/auc/filter/'
    if not os.path.exists(dst):
        os.makedirs(dst)
...
def plot_auc(args, aucs_cw, aucs_svm, aucs_lr, aucs_filter, plot_cpt = ['Controls', 'Patients']):
    folder = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + 'resnet_cw' + str(args.depth) + '/auc/'
    if not os.path.exists(folder):
        os.makedirs(folder)
...
def plot_top10(args, plot_cpt = ['Controls', 'Patients'], layer = 1):
    folder = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/' + str(layer) + '_rot_cw/'
    if not os.path.exists(folder):
        os.makedirs(folder)
...
def plot_concept_representation(args, val_loader, model, whitened_layers, plot_cpt = ['Controls','Patients'], activation_mode = 'mean'):    
    with torch.no_grad():
        dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) +'/representation/'
        if not os.path.exists(dst):
            os.makedirs(dst)
        model.eval()
        model = model.module
...
def concept_permutation_importance(args, val_loader, layer, criterion, arch='resnet_cw', dataset='MD', num_concepts=7):
    model = load_resnet_model(args, arch=arch, depth=18, whitened_layer=layer, dataset=dataset)
    #print(model)
...
def concept_gradient_importance(args, val_loader, layer, criterion, arch='resnet_cw', dataset='MD', num_classes=2):
    model = load_resnet_model(args, arch=arch, depth=18, whitened_layer=layer, dataset=dataset)
    #print(model)
    # model.eval()
    model = model.module
...
def saliency_map_class(args, val_loader, layer, arch='resnet_cw', dataset='MD'):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/saliency_map/'
...
def saliency_map_concept(args, val_loader, layer, arch='resnet_cw', dataset='MD', num_concepts=7):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/saliency_map_concept/'
    # dst = '/usr/xtmp/zhichen/temp_plots/'
    try:
        os.makedirs(dst)
    except:
...
def saliency_map_concept_cover(args, val_loader, layer, arch='resnet_cw', dataset='MD', num_concepts=7):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/saliency_map_concept_cover_fine_grain/'
    try:
        os.makedirs(dst)
    except:
        pass
...
def saliency_map_concept_cover_2(args, val_loader, layer, arch='resnet_cw', dataset='MD', num_concepts=7):
    dst = '/content/plot/' + '_'.join(args.concepts.split(',')) + '/' + args.arch + str(args.depth) + '/saliency_map_concept_cover_fine_grain_2/'
    try:
        os.makedirs(dst)
    except:
        pass
...
def load_resnet_model(args, arch = 'resnet_original', depth=18, checkpoint_folder="/content/checkpoints/content/checkpoints", whitened_layer=None, dataset = 'MD'):
